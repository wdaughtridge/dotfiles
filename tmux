...
# Status line
set -g status-left "#[fg=colour255,bold,bg=darkmagenta] #S #[fg=white,bg=default] "
set -g status-left-length 64
set -g status-right "#[fg=colour255,bold,bg=darkorange] %H:%M %m/%d/%Y "

# Window status
set -g window-status-style "fg=colour255,bg=green"
set -g window-status-format "  #I  "

# Current window status
set -g window-status-current-style "fg=colour255,bold,bg=green"
